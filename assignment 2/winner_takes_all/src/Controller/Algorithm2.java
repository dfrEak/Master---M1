...
public class Algorithm2 {
     ...
     */
    public static ResultWTASingle calculateWTASingle(Input input, ArrayList<Weight> weight, ArrayList<Double> threshold, int turn)
    {
...
//        e=(int) Math.pow(e-1, 2);
        e=CalculateE(input, weight, threshold);
     ...
     */
    public static ResultWTA calculateWTA(Input input, ArrayList<Weight> weight, ArrayList<Double> threshold)
    {
        ...
        {
           result_single=calculateWTASingle(input, weight, threshold, turn);
        ...
        str.append(")");
        str.append(" - E=");
        str.append(CalculateE(result_single.getInput(), weight, threshold));
        str.append("\n");
        str.append("=================================================\n");
        str.append("=======================END=======================\n");
        str.append("=================================================\n");
    ...
    public static double CalculateE(Input input, ArrayList<Weight> weight, ArrayList<Double> threshold)
    {
        double retval=0;
        for(int i=0;i<input.getInput().size();i++)
        {
